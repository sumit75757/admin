...
export class OffersComponent implements OnInit {
  ...
  submit() {
    if (this.offer.valid) {
      ...
      formdata.set('offerName', this.offer.controls['offerName'].value)
      formdata.set('productId', this.offer.controls['productId'].value)
      formdata.set('code', this.offer.controls['code'].value)
    
      if (this.productId) {
        this.api.updateOffers(formdata,this.productId).subscribe(res => {
          this.toastr.success('offer Update!')
          this.getoffer()
          console.log(res);
        })
      } else {
        this.api.addOffer(formdata).subscribe(res => {
